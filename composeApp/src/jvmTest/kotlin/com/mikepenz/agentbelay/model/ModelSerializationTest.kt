...
class ModelSerializationTest {
    ...
    fun appSettingsGlobalHotkeysRoundTrip() {
        val approve = com.mikepenz.agentbelay.model.GlobalHotkey(
            keyCode = java.awt.event.KeyEvent.VK_A,
            modifiers = setOf(
                com.mikepenz.agentbelay.model.HotkeyModifier.CONTROL,
                com.mikepenz.agentbelay.model.HotkeyModifier.SHIFT,
            ),
        )
        val deny = com.mikepenz.agentbelay.model.GlobalHotkey(
            keyCode = java.awt.event.KeyEvent.VK_D,
            modifiers = setOf(com.mikepenz.agentbelay.model.HotkeyModifier.META),
        )
