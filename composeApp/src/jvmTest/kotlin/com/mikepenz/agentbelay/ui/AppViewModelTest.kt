...
class AppViewModelTest {
    ...
    fun `resolveTab maps indexes correctly in dev and non-dev`() {
        // Non-dev: Approvals, History, Statistics, Usage, Insights, Settings
        ...
        assertEquals(AppTab.Insights, resolveTab(4, devMode = false))
        assertEquals(AppTab.Settings, resolveTab(5, devMode = false))

        // Dev: Approvals, History, Statistics, Usage, Insights, ProtectionLog, Settings
        ...
        assertEquals(AppTab.Insights, resolveTab(4, devMode = true))
        assertEquals(AppTab.ProtectionLog, resolveTab(5, devMode = true))
        assertEquals(AppTab.Settings, resolveTab(6, devMode = true))
    }
